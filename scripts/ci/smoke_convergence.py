...
Redis container with the fractalsql module preloaded.
...
def main():
    ...
    # Reply shape depends on the server version:
    #   Redis 7.0+  — RESP3 map (dict from _parse)
    #   Redis 6.2   — flat array of key/value pairs (list), because
    #                 the module falls back to ReplyWithArray when
    #                 RedisModule_ReplyWithMap is NULL.
    # Normalize to a dict.
